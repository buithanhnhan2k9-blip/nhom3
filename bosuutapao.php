<?php
$shirts = [
    ["name"=>"Áo Oversize Đen","price"=>350000,"image"=>"image/ao thun.jpeg","tag"=>"NEW"],
    ["name"=>"Áo Local Brand Trắng","price"=>420000,"image"=>"image/ao brand.jpg","tag"=>"HOT"],
    ["name"=>"Áo Graphic Tee","price"=>390000,"image"=>"image/ao Graphic Tee.jpg","tag"=>"TREND"],
    ["name"=>"Áo Hoodie Đen","price"=>650000,"image"=>"image/ao thun denjpg","tag"=>"BEST"],
    ["name"=>"Áo Polo Nam","price"=>299000,"image"=>"image/polo.jpg","tag"=>"SALE"],
    ["name"=>"Áo Sơ Mi Local","price"=>490000,"image"=>"image/ao so mi.webp","tag"=>"LIMITED"]
];
?>
