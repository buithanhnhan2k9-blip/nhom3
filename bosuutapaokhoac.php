...
$jackets = [
    ["id"=>201, "name"=>"Áo Khoác Bomber Đen","price"=>550000,"image"=>"image/Áo Khoác Bomber Đen.jpg","tag"=>"NEW"],
    ["id"=>202, "name"=>"Áo Khoác Dù 2 Lớp","price"=>450000,"image"=>"image/V.jpg","tag"=>"HOT"],
    ["id"=>203, "name"=>"Áo Khoác Varsity Nhám","price"=>690000,"image"=>"image/Áo Khoác Varsity Nhám.jpg","tag"=>"TREND"],
    ["id"=>204, "name"=>"Áo Khoác Denim Bụi","price"=>750000,"image"=>"image/Áo Khoác Denim Bụi.jpg","tag"=>"BEST"],
    ["id"=>205, "name"=>"Áo Cardigan Len Nam","price"=>399000,"image"=>"image/Áo Cardigan Len Nam.webp","tag"=>"SALE"],
    ["id"=>206, "name"=>"Áo Khoác Da Biker","price"=>890000,"image"=>"image/Áo Khoác Da Biker.jpg","tag"=>"LIMITED"]
];
?>
...
<head>
    ...
    <title>Bộ Sưu Tập Áo Khoác</title>
    <link rel="stylesheet" href="style/bosuutapaokhoac.css">
...
<section class="products">
    ...
    <div class="container">
        <?php foreach($jackets as $j): ?>
        <div class="card">
            <span class="card-tag"><?= $j['tag'] ?></span>
            
            <a href="collection-detail.php?id=<?= $j['id'] ?>">
                <img src="<?= $j['image'] ?>" alt="<?= $j['name'] ?>">
            </a>
            
            <div class="card-content">
                <h3>
                    <a href="collection-detail.php?id=<?= $j['id'] ?>" style="text-decoration: none; color: inherit;">
                        <?= $j['name'] ?>
                    </a>
                </h3>
                <p><?= number_format($j['price'], 0, ',', '.') ?>đ</p>
                
                <form method="POST" action="">
                    <input type="hidden" name="product_name" value="<?= $j['name'] ?>">
                    <input type="hidden" name="product_price" value="<?= $j['price'] ?>">
                    <input type="hidden" name="product_image" value="<?= $j['image'] ?>">
